...
figure_scripts = [
    ...
    [4, 'I', 'cascades/feedback_through_brain/MBIN_recurrent-partners.py', 'make heatmap of sensory modalities to DANs'],
    ...
    [6, 'H', '', ''],
    [6, 'I', '', ''],
    [6, 'J', 'interhemsiphere/excied-edges_brain-power.py', 'EXPERIMENT 2: (depends on EXPERIMENT 1)'],
    [6, 'K', '', ''],
    [7, 'A', '', ''],
    [7, 'B', '', ''],
    [7, 'C', '', ''],
...
sup_figure_scripts = [
    ...
    ['S6', '', '', ''],
    ['S7', '', '', ''],
    ['S8', 'A', None, 'Plot from Benjamin Pedigo'],
    ['S8', 'B', 'small_plots/cluster-level-metrics.py', 'distribution of intracluster similarity'],
    ['S8', 'C', 'small_plots/cluster-level-metrics.py', 'load clusters and plot counts'],
    ['S8', 'D', 'scripts/cluster_analysis/general_celltype_classification.py', 'celltype plot'],
    ['S9', 'A', 'scripts/network_analysis/hubs_by_degree.py', 'location in cluster structure'],
    ['S9', 'B', 'scripts/network_analysis/hubs_by_degree.py', 'location in cluster structure'],
    ['S9', 'C', 'scripts/network_analysis/hubs_by_degree.py', 'location in cluster structure'],
    ['S9', 'D', 'scripts/network_analysis/hubs_by_degree.py', 'location in cluster structure'],
    ['S10', '', '', ''],
    ['S11', 'D', '', ''],
    ['S11', 'E', '', ''],
    ['S12', '', '', ''],
    ['S13', '', '', ''],
    ['S14', '', '', ''],
    ['S15', 'A', 'scripts/interhemisphere/ipsi_bilat_contra_plotting.py', 'number of dendrite_axon types'],
    ['S15', 'B', 'scripts/interhemisphere/ipsi_bilat_contra_plotting.py', 'plotting example neurons for supplemental figure'],
    ['S15', 'C', 'scripts/interhemisphere/ipsi_bilat_contra_plotting.py', 'plotting example neurons for supplemental figure'],
    ['S16', '', '', ''],
    ['S17', '', '', ''],
    ['S18', 'A', 'scripts/interhemisphere/contra_bilateral_loops_detail.py', 'cell types of loops'],
    ['S18', 'B', 'scripts/interhemisphere/contra_bilateral_loops_detail.py', 'location in cluster structure'],
    ['S18', 'C', 'scripts/interhemisphere/contra_bilateral_loops_detail.py', 'plot partners'],
    ['S18', 'D', 'scripts/interhemisphere/contra_bilateral_loops_detail.py', 'plot cell types'],
    ['S19', '', '', ''],
    ['S20', '', '', ''],
    ['S21', '', '', ''],
    ['S22', '', '', ''],
