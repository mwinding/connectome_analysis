...
skeletons_csv = pd.read_csv('axon_dendrite_data/splittable_skeletons_left1.csv', header=0, skipinitialspace=True, keep_default_na = False)
...
connectors = pd.read_csv('axon_dendrite_data/splittable_connectors_left1.csv', header=0, skipinitialspace=True, keep_default_na = False)
...
with open('axon_dendrite_data/splittable_connectdists_left1_raw.csv', mode='w') as csv_file:
...
with open('axon_dendrite_data/splittable_connectdists_left1_norm.csv', mode='w') as csv_file:
    csv_writer = csv.writer(csv_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    csv_writer.writerow(['nodeid', 'type', 'distance_root'])
    for i in range(len(connectdists_list_norm)):
        for j in range(len(connectdists_list_norm[i])):
            ...
            csv_writer.writerow([nodeid, typ, distance_root])
'''
with open('axon_dendrite_data/splittable_connectdists_left1_norm2.csv', mode='w') as csv_file:
    csv_writer = csv.writer(csv_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    csv_writer.writerow(['nodeid', 'type', 'distance_root'])
