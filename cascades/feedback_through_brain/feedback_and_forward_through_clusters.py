...
cluster_hit_hist_lvl7 = []
for hit_hist in cluster_hit_hist_list:
    clustered_hist = []
    ...
    cluster_hit_hist_lvl7.append(clustered_hist)

# summed cluster cascades per cluster group (hops remain intact)
summed_hops_hist_lvl7 = []
