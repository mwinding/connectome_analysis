...
plt.savefig('plots/noloops_stop_testing.pdf', format='pdf', bbox_inches='tight')
...
# %%
# plot comparison of loops to no loops
...
plt.savefig('plots/stoping_at_descending_test_loops.pdf', format='pdf', bbox_inches='tight')
...
ORN1_hits = hit_hist[hit_hist_stop[:, 0]>0, 0]
ORN2_hits = hit_hist[hit_hist_stop[:, 1]>0, 1]
ORN3_hits = hit_hist[hit_hist_stop[:, 2]>0, 2]
ORN4_hits = hit_hist[hit_hist_stop[:, 3]>0, 3]
ORN5_hits = hit_hist[hit_hist_stop[:, 4]>0, 4]
ORN6_hits = hit_hist[hit_hist_stop[:, 5]>0, 5]
ORN7_hits = hit_hist[hit_hist_stop[:, 6]>0, 6]
ORN8_hits = hit_hist[hit_hist_stop[:, 7]>0, 7]
ORN9_hits = hit_hist[hit_hist_stop[:, 8]>0, 8]
ORN10_hits = hit_hist[hit_hist_stop[:, 9]>0, 9]
